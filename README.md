...
Library so that the ViewHierarchy can viewed with the the tool in the SDK.
...
```groovy
dependencies {
       compile 'com.github.shareme:gwsdroidviewserver:library:tag@aar'
...
How to wire up the Activity is right in the javadoc of the ViewServer class.
...
[Roman's' ViewServer](http://www.apache.org/licenses/LICENSE-2.0)
